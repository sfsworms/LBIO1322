...
Attention que la vitesse obtenue est une vitesse en absorbance/seconde. Pour trouver la vitesse en mol/seconde, vous devez utiliser le coefficient d'extinction molaire de la nitrocéfine à 482 nm, 17400 M-1cm-1. 
...
```{r echo=FALSE}
plot(test.df$concentration, test.df$vitesse)
x <- c(0:100) # x représente un range de concentration pour laquelle nous calculerons la vitesse théorique. Si vous changez cela pour vos valeur, modifier cela pour couvrir un range qui couvre vos concentrations. Attention c(a:b) ne donne que les entier entre a et b.
y <- (6.069*x/(4.701+x)) #On calcule ici les vitesse théorique à l'aide des Km et Vmax obtenu plus haut et du range de concentration théorique.
