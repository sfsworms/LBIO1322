...
```{r}
mm.nls <- nls(mm$rate ~ (Vmax * mm$conc / (Km + mm$conc)), data=mm, start=list(Km=4, Vmax=3)) 
summary(mm.nls)
```
...
y <- (3.51533*x/(1.08707+x)) #On calcule ici les vitesse théorique à l'aide des Km et Vmax obtenu plus haut et du range de concentration théorique.
lines(x, y, lty="dotted", col="red")

read.csv("Z:/Encadrement/Assistanat/Q2/LBIO1322/R Code/mm.csv") -> mm
